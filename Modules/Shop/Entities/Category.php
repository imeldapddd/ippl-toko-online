...
class Category extends Model
{
    ...
    {
        return $this->belongsToMany('Modules\Shop\Entities\Product', 'shop_categories_product', 'product_id','category_id');
    }
    ...
    public static function childIDs($parentID = null)
    {
        ...
        if (!empty($categories)){
            foreach ($categories as $category){
                $childIDs[] = $categories->id;
                $childIDs = array_merge($childIDs, Category::childIDs($categories->id));
            }
        }
